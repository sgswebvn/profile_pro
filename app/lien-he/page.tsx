           ...
           <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                 ...
                 <div>
                    ...
                    <div style={{ color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>Tòa Nhà ABC, Phường Y, Quận 1, TPHCM</div>
                 </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                 ...
                 <div>
                    ...
                    <div style={{ color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>0123-456-789 (Zalo 24/7)</div>
                 </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                 ...
                 <div>
                    ...
                    <div style={{ color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>contact@webcrafter.vn</div>
                 </div>
              </div>
           </div>
